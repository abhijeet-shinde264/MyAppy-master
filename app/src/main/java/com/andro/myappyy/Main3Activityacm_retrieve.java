...
public class Main3Activityacm_retrieve extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_main3_activityacm_retrieve);


        eventslist = (RecyclerView) findViewById(R.id.recyclerviewacm);
    ...
    private void validateeventslist() {
        ...
        FirebaseRecyclerAdapter<Events, Main3Activityacm_retrieve.eventslistviewholder> firebaseRecyclerAdapter =
                new FirebaseRecyclerAdapter<Events, Main3Activityacm_retrieve.eventslistviewholder>
                (
                        Events.class, R.layout.events_info, Main3Activityacm_retrieve.eventslistviewholder.class, reference
                ) {
            @Override
            protected void populateViewHolder(Main3Activityacm_retrieve.eventslistviewholder viewHolder, Events model, int position) {
               ...
               final String s6=model.getLink();
                ...
                viewHolder.itemView.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        Intent intent = new Intent(Main3Activityacm_retrieve.this, Android_details_student.class);
