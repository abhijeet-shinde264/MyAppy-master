...
public class Main3Activityand extends AppCompatActivity {
    ...
    private EditText eventname,dateed,targeted,info,link,optionlink;
    ...
    String event,date1,target,info1,link1,link2;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        dateed=(EditText)findViewById(R.id.edanddate) ;
        ...
        optionlink = findViewById(R.id.edandlink1);
        ...
        dateed.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                // TODO Auto-generated method stub
                new DatePickerDialog(Main3Activityand.this, date, myCalendar
        ...
        save.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                link2 = optionlink.getText().toString();
                if(TextUtils.isEmpty(event))
                {
                    Toast.makeText(Main3Activityand.this,"please enter the Event Name",Toast.LENGTH_LONG).show();
                }
                else if(TextUtils.isEmpty(date1))
                {
                    Toast.makeText(Main3Activityand.this,"Please fill the date",Toast.LENGTH_LONG).show();
                }
                else if(TextUtils.isEmpty(info1))
                {
                    Toast.makeText(Main3Activityand.this,"Please fill the profile",Toast.LENGTH_LONG).show();
                }
                else if(TextUtils.isEmpty(target))
                {
                    Toast.makeText(Main3Activityand.this,"Please fill the targeted students",Toast.LENGTH_LONG).show();
                }
                else if(TextUtils.isEmpty(link1))
                {
                    Toast.makeText(Main3Activityand.this,"Please fill the link",Toast.LENGTH_LONG).show();
                }
                else if(postImageUri==null)
                {
                    Toast.makeText(Main3Activityand.this,"Please Select the Image to Post",Toast.LENGTH_LONG).show();
                }
                else {
