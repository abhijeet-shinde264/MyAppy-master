...
public class Main3Activitycsi_retrieve_student extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_main3_activitycsi_retrieve_student);


        eventslist = (RecyclerView) findViewById(R.id.recyclerviewcsi_student);
    ...
    private void validateeventslist() {
        ...
        reference= FirebaseDatabase.getInstance().getReference().child("Chapters").child("CSI");

        FirebaseRecyclerAdapter<Events, Main3Activitycsi_retrieve_student.eventslistviewholder> firebaseRecyclerAdapter=new FirebaseRecyclerAdapter<Events,Main3Activitycsi_retrieve_student.eventslistviewholder>
                (
                        Events.class,R.layout.events_info, Main3Activitycsi_retrieve_student.eventslistviewholder.class,reference
                ) {
            @Override
            protected void populateViewHolder(Main3Activitycsi_retrieve_student.eventslistviewholder viewHolder, Events model, int position) {
                ...
                viewHolder.itemView.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        Intent intent=new Intent(Main3Activitycsi_retrieve_student.this,Android_details_student.class);
