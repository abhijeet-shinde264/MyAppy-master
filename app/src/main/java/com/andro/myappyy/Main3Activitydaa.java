...
public class Main3Activitydaa extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_main3_activitydaa);
        firebaseAuth = FirebaseAuth.getInstance();

        storageReference = FirebaseStorage.getInstance().getReference();


        postref= FirebaseDatabase.getInstance().getReference().child("Clubs").child("DA");

        eventname=(EditText)findViewById(R.id.eddaaeventname) ;
        dateed=(EditText)findViewById(R.id.eddaadate) ;
        targeted=(EditText)findViewById(R.id.eddaatarget) ;
        uploadBtn1=(Button)findViewById(R.id.bdaaupload);
        info=(EditText)findViewById(R.id.eddaaprofile);
        link=(EditText)findViewById(R.id.eddaalink);

        save=(Button)findViewById(R.id.bdaasave);
        profile=(ImageView)findViewById(R.id.imgdaa) ;
        ...
        dateed.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                // TODO Auto-generated method stub
                new DatePickerDialog(Main3Activitydaa.this, date, myCalendar
        ...
        save.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                {
                    Toast.makeText(Main3Activitydaa.this,"Please enter the Event Name",Toast.LENGTH_LONG).show();
                }
                else if(TextUtils.isEmpty(date1))
                {
                    Toast.makeText(Main3Activitydaa.this,"Please fill the date",Toast.LENGTH_LONG).show();
                }
                else if(TextUtils.isEmpty(info1))
                {
                    Toast.makeText(Main3Activitydaa.this,"Please fill the profile",Toast.LENGTH_LONG).show();
                }
                else if(TextUtils.isEmpty(target))
                {
                    Toast.makeText(Main3Activitydaa.this,"Please fill the targeted students",Toast.LENGTH_LONG).show();
                }
                else if(TextUtils.isEmpty(link1))
                {
                    Toast.makeText(Main3Activitydaa.this,"Please fill the link",Toast.LENGTH_LONG).show();
                }
                else if(postImageUri==null)
                {
                    Toast.makeText(Main3Activitydaa.this,"Please Select the Image to Post",Toast.LENGTH_LONG).show();
                }
                else {
                    ...
                    StorageReference filepath=storageReference.child("daimages").child(postdate+posttime+".jpg");

                    final StorageReference thumb_filepath=storageReference.child("daimages").child(postdate+posttime+".jpg");
        ...
        postref.child(uid).updateChildren(postmap).addOnCompleteListener(new OnCompleteListener() {
            ...
            public void onComplete(@NonNull Task task) {
                if(task.isSuccessful())
                {
                    ...
                    Intent intent=new Intent(Main3Activitydaa.this,Main3Activitydaa_retrieve.class);
                ...
                else
                {
                    ...
                    Toast.makeText(Main3Activitydaa.this,"Error Occured :"+msg,Toast.LENGTH_LONG).show();
                }
