...
public class Main3Activitydaa_retrieve extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_main3_activitydaa_retrieve);
        eventslist = (RecyclerView) findViewById(R.id.recyclerviewdaa);
    ...
    private void validateeventslist() {
        ...
        reference= FirebaseDatabase.getInstance().getReference().child("Clubs").child("DA");

        FirebaseRecyclerAdapter<Events, Main3Activitydaa_retrieve.eventslistviewholder> firebaseRecyclerAdapter=new FirebaseRecyclerAdapter<Events, Main3Activitydaa_retrieve.eventslistviewholder>
                (
                        Events.class,R.layout.events_info, Main3Activitydaa_retrieve.eventslistviewholder.class,reference
                ) {
            @Override
            protected void populateViewHolder(Main3Activitydaa_retrieve.eventslistviewholder viewHolder, Events model, int position) {
                ...
                viewHolder.itemView.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        Intent intent=new Intent(Main3Activitydaa_retrieve.this,Android_details_student.class);
