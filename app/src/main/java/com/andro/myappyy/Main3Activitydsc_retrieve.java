...
public class Main3Activitydsc_retrieve extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_main3_activitydsc_retrieve);


        eventslist = (RecyclerView) findViewById(R.id.recyclerviewdsc);
    ...
    private void validateeventslist() {
        ...
        FirebaseRecyclerAdapter<Events, Main3Activitydsc_retrieve.eventslistviewholder> firebaseRecyclerAdapter=new FirebaseRecyclerAdapter<Events, Main3Activitydsc_retrieve.eventslistviewholder>
                (
                        Events.class,R.layout.events_info, Main3Activitydsc_retrieve.eventslistviewholder.class,reference
                ) {
            @Override
            protected void populateViewHolder(Main3Activitydsc_retrieve.eventslistviewholder viewHolder, Events model, int position) {
                ...
                viewHolder.itemView.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        Intent intent=new Intent(Main3Activitydsc_retrieve.this,Android_details_student.class);
