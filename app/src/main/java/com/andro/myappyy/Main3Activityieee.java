...
public class Main3Activityieee extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_main3_activityieee);


        storageReference = FirebaseStorage.getInstance().getReference();


        postref= FirebaseDatabase.getInstance().getReference().child("Chapters").child("IEEE");

        eventname=(EditText)findViewById(R.id.edieeeeventname) ;
        dateed=(EditText)findViewById(R.id.edieeedate) ;
        final Calendar myCalendar = Calendar.getInstance();
        targeted=(EditText)findViewById(R.id.edieeetarget) ;
        uploadBtn1=(Button)findViewById(R.id.bieeeupload);
        info=(EditText)findViewById(R.id.edieeeprofile);
        link=(EditText)findViewById(R.id.edieeelink);

        save=(Button)findViewById(R.id.bieesave);
        profile=(ImageView)findViewById(R.id.imgiee) ;
        ...
        dateed.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                // TODO Auto-generated method stub
                new DatePickerDialog(Main3Activityieee.this, date, myCalendar
        ...
        save.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                {
                    Toast.makeText(Main3Activityieee.this,"Please enter the Event Name",Toast.LENGTH_LONG).show();
                }
                else if(TextUtils.isEmpty(date1))
                {
                    Toast.makeText(Main3Activityieee.this,"Please fill the date",Toast.LENGTH_LONG).show();
                }
                else if(TextUtils.isEmpty(info1))
                {
                    Toast.makeText(Main3Activityieee.this,"Please fill the profile",Toast.LENGTH_LONG).show();
                }
                else if(TextUtils.isEmpty(target))
                {
                    Toast.makeText(Main3Activityieee.this,"Please fill the targeted students",Toast.LENGTH_LONG).show();
                }
                else if(TextUtils.isEmpty(link1))
                {
                    Toast.makeText(Main3Activityieee.this,"Please fill the link",Toast.LENGTH_LONG).show();
                }
                else if(postImageUri==null)
                {
                    Toast.makeText(Main3Activityieee.this,"Please Select the Image to Post",Toast.LENGTH_LONG).show();
                }
                else {
                    ...
                    StorageReference filepath=storageReference.child("ieeeimages").child(postdate+posttime+".jpg");

                    final StorageReference thumb_filepath=storageReference.child("ieeeimages").child(postdate+posttime+".jpg");
        ...
        postref.child(uid).updateChildren(postmap).addOnCompleteListener(new OnCompleteListener() {
            ...
            public void onComplete(@NonNull Task task) {
                if(task.isSuccessful())
                {
                    ...
                    Intent intent=new Intent(Main3Activityieee.this,Main3Activityieee_retrieve.class);
                ...
                else
                {
                    ...
                    Toast.makeText(Main3Activityieee.this,"Error Occured :"+msg,Toast.LENGTH_LONG).show();
                }
