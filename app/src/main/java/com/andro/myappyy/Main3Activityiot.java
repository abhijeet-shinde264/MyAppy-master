...
public class Main3Activityiot extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_main3_activityiot);


        storageReference = FirebaseStorage.getInstance().getReference();


        postref= FirebaseDatabase.getInstance().getReference().child("Clubs").child("Iotclub");

        eventname=(EditText)findViewById(R.id.edioteventname) ;
        dateed=(EditText)findViewById(R.id.ediotdate) ;
        targeted=(EditText)findViewById(R.id.ediottarget) ;
        uploadBtn1=(Button)findViewById(R.id.biotupload);
        info=(EditText)findViewById(R.id.ediotprofile);
        link=(EditText)findViewById(R.id.ediotlink);

        save=(Button)findViewById(R.id.biotsave);
        profile=(ImageView)findViewById(R.id.imgiot) ;
        ...
        dateed.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                // TODO Auto-generated method stub
                new DatePickerDialog(Main3Activityiot.this, date, myCalendar
        ...
        save.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                {
                    Toast.makeText(Main3Activityiot.this,"Please enter the Event Name",Toast.LENGTH_LONG).show();
                }
                else if(TextUtils.isEmpty(date1))
                {
                    Toast.makeText(Main3Activityiot.this,"Please fill the date",Toast.LENGTH_LONG).show();
                }
                else if(TextUtils.isEmpty(info1))
                {
                    Toast.makeText(Main3Activityiot.this,"Please fill the profile",Toast.LENGTH_LONG).show();
                }
                else if(TextUtils.isEmpty(target))
                {
                    Toast.makeText(Main3Activityiot.this,"Please fill the targeted students",Toast.LENGTH_LONG).show();
                }
                else if(TextUtils.isEmpty(link1))
                {
                    Toast.makeText(Main3Activityiot.this,"Please fill the link",Toast.LENGTH_LONG).show();
                }
                else if(postImageUri==null)
                {
                    Toast.makeText(Main3Activityiot.this,"Please Select the Image to Post",Toast.LENGTH_LONG).show();
                }
                else {
                    ...
                    StorageReference filepath=storageReference.child("iotimages").child(postdate+posttime+".jpg");

                    final StorageReference thumb_filepath=storageReference.child("iotimages").child(postdate+posttime+".jpg");
        ...
        postref.child(uid).updateChildren(postmap).addOnCompleteListener(new OnCompleteListener() {
            ...
            public void onComplete(@NonNull Task task) {
                if(task.isSuccessful())
                {
                    ...
                    Intent intent=new Intent(Main3Activityiot.this,Main3Activityiot_retrieve.class);
                ...
                else
                {
                    ...
                    Toast.makeText(Main3Activityiot.this,"Error Occured :"+msg,Toast.LENGTH_LONG).show();
                }
