...
public class Main3Activityiot_retrieve extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_main3_activityiot_retrieve);


        eventslist = (RecyclerView) findViewById(R.id.recyclerviewiot);
    ...
    private void validateeventslist() {
        ...
        FirebaseRecyclerAdapter<Events, Main3Activityiot_retrieve.eventslistviewholder> firebaseRecyclerAdapter=new FirebaseRecyclerAdapter<Events, Main3Activityiot_retrieve.eventslistviewholder>
                (
                        Events.class,R.layout.events_info, Main3Activityiot_retrieve.eventslistviewholder.class,reference
                ) {
            @Override
            protected void populateViewHolder(Main3Activityiot_retrieve.eventslistviewholder viewHolder, Events model, int position) {
               ...
               final String s6=model.getLink();
                ...
                viewHolder.itemView.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        Intent intent=new Intent(Main3Activityiot_retrieve.this,Android_details_student.class);
