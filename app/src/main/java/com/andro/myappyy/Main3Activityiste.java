...
public class Main3Activityiste extends AppCompatActivity {
    ...
    String event,date1,target,info1,link1,uid;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_main3_activityiste);
        firebaseAuth = FirebaseAuth.getInstance();

        storageReference = FirebaseStorage.getInstance().getReference();


        postref= FirebaseDatabase.getInstance().getReference().child("Chapters").child("ISTE");

        eventname=(EditText)findViewById(R.id.edisteeventname) ;
        dateed=(EditText)findViewById(R.id.edistedate) ;
        final Calendar myCalendar = Calendar.getInstance();
        targeted=(EditText)findViewById(R.id.edistetarget) ;
        uploadBtn1=(Button)findViewById(R.id.bisteupload);
        info=(EditText)findViewById(R.id.edisteprofile);
        link=(EditText)findViewById(R.id.edistelink);

        save=(Button)findViewById(R.id.bistesave);
        profile=(ImageView)findViewById(R.id.imgiste) ;
        ...
        dateed.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                // TODO Auto-generated method stub
                new DatePickerDialog(Main3Activityiste.this, date, myCalendar
        ...
        save.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                {
                    Toast.makeText(Main3Activityiste.this,"Please enter the Event Name",Toast.LENGTH_LONG).show();
                }
                else if(TextUtils.isEmpty(date1))
                {
                    Toast.makeText(Main3Activityiste.this,"Please fill the date",Toast.LENGTH_LONG).show();
                }
                else if(TextUtils.isEmpty(info1))
                {
                    Toast.makeText(Main3Activityiste.this,"Please fill the profile",Toast.LENGTH_LONG).show();
                }
                else if(TextUtils.isEmpty(target))
                {
                    Toast.makeText(Main3Activityiste.this,"Please fill the targeted students",Toast.LENGTH_LONG).show();
                }
                else if(TextUtils.isEmpty(link1))
                {
                    Toast.makeText(Main3Activityiste.this,"Please fill the link",Toast.LENGTH_LONG).show();
                }
                else if(postImageUri==null)
                {
                    Toast.makeText(Main3Activityiste.this,"Please Select the Image to Post",Toast.LENGTH_LONG).show();
                }
                else {
                    ...
                    StorageReference filepath=storageReference.child("isteimages").child(postdate+posttime+".jpg");

                    final StorageReference thumb_filepath=storageReference.child("isteimages").child(postdate+posttime+".jpg");
        ...
        postref.child(uid).updateChildren(postmap).addOnCompleteListener(new OnCompleteListener() {
            ...
            public void onComplete(@NonNull Task task) {
                if(task.isSuccessful())
                {
                    ...
                    Intent intent=new Intent(Main3Activityiste.this,Main3Activityiste_retrieve.class);
                ...
                else
                {
                    ...
                    Toast.makeText(Main3Activityiste.this,"Error Occured :"+msg,Toast.LENGTH_LONG).show();
                }
