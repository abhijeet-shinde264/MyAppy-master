...
public class Main3Activitymalai extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_main3_activitymalai);


        storageReference = FirebaseStorage.getInstance().getReference();


        postref= FirebaseDatabase.getInstance().getReference().child("Clubs").child("Malaiclub");

        eventname=(EditText)findViewById(R.id.ed4) ;
        dateed=(EditText)findViewById(R.id.ed5) ;
         targeted=(EditText)findViewById(R.id.ed7) ;
      uploadBtn1=(Button)findViewById(R.id.b4);
      info=(EditText)findViewById(R.id.ed6);
      link=(EditText)findViewById(R.id.edmalailink);

        save=(Button)findViewById(R.id.b6);
        profile=(ImageView)findViewById(R.id.img3) ;
        ...
        dateed.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                // TODO Auto-generated method stub
                new DatePickerDialog(Main3Activitymalai.this, date, myCalendar
        ...
        save.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
               ...
               target=targeted.getText().toString();
                ...
                {
                    Toast.makeText(Main3Activitymalai.this,"Please enter the Event Name",Toast.LENGTH_LONG).show();
                }
                else if(TextUtils.isEmpty(date1))
                {
                    Toast.makeText(Main3Activitymalai.this,"Please fill the date",Toast.LENGTH_LONG).show();
                }
                else if(TextUtils.isEmpty(info1))
                {
                    Toast.makeText(Main3Activitymalai.this,"Please fill the profile",Toast.LENGTH_LONG).show();
                }
                else if(TextUtils.isEmpty(target))
                {
                    Toast.makeText(Main3Activitymalai.this,"Please fill the targeted students",Toast.LENGTH_LONG).show();
                }
                else if(TextUtils.isEmpty(link1))
                {
                    Toast.makeText(Main3Activitymalai.this,"Please fill the link",Toast.LENGTH_LONG).show();
                }
                else if(postImageUri==null)
                {
                    Toast.makeText(Main3Activitymalai.this,"Please Select the Image to Post",Toast.LENGTH_LONG).show();
                }
                else {
                    ...
                    StorageReference filepath=storageReference.child("malaiimages").child(postdate+posttime+".jpg");

                    final StorageReference thumb_filepath=storageReference.child("malaiimages").child(postdate+posttime+".jpg");
        ...
        postref.child(uid).updateChildren(postmap).addOnCompleteListener(new OnCompleteListener() {
            ...
            public void onComplete(@NonNull Task task) {
                if(task.isSuccessful())
                {
                    ...
                    Intent intent=new Intent(Main3Activitymalai.this,Main3Activitymalai_retrieve.class);
                ...
                else
                {
                    ...
                    Toast.makeText(Main3Activitymalai.this,"Error Occured :"+msg,Toast.LENGTH_LONG).show();
                }
