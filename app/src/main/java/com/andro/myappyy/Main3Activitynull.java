...
public class Main3Activitynull extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        postref= FirebaseDatabase.getInstance().getReference().child("Clubs").child("NULL");

        eventname=(EditText)findViewById(R.id.ednulleventname) ;
        dateed=(EditText)findViewById(R.id.ednulldate) ;
        targeted=(EditText)findViewById(R.id.ednulltarget) ;
        uploadBtn1=(Button)findViewById(R.id.bnullupload);
        info=(EditText)findViewById(R.id.ednullprofile);
        link=(EditText)findViewById(R.id.ednulllink);

        save=(Button)findViewById(R.id.bnullinsert);
        profile=(ImageView)findViewById(R.id.imgnull) ;
        ...
        dateed.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                // TODO Auto-generated method stub
                new DatePickerDialog(Main3Activitynull.this, date, myCalendar
        ...
        save.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                {
                    Toast.makeText(Main3Activitynull.this,"Please enter the Event Name",Toast.LENGTH_LONG).show();
                }
                else if(TextUtils.isEmpty(date1))
                {
                    Toast.makeText(Main3Activitynull.this,"Please fill the date",Toast.LENGTH_LONG).show();
                }
                else if(TextUtils.isEmpty(info1))
                {
                    Toast.makeText(Main3Activitynull.this,"Please fill the profile",Toast.LENGTH_LONG).show();
                }
                else if(TextUtils.isEmpty(target))
                {
                    Toast.makeText(Main3Activitynull.this,"Please fill the targeted students",Toast.LENGTH_LONG).show();
                }
                else if(TextUtils.isEmpty(link1))
                {
                    Toast.makeText(Main3Activitynull.this,"Please fill the link",Toast.LENGTH_LONG).show();
                }
                else if(postImageUri==null)
                {
                    Toast.makeText(Main3Activitynull.this,"Please Select the Image to Post",Toast.LENGTH_LONG).show();
                }
                else {
                    ...
                    StorageReference filepath=storageReference.child("nullimages").child(postdate+posttime+".jpg");

                    final StorageReference thumb_filepath=storageReference.child("nullimages").child(postdate+posttime+".jpg");
        ...
        postref.child(uid).updateChildren(postmap).addOnCompleteListener(new OnCompleteListener() {
            ...
            public void onComplete(@NonNull Task task) {
                if(task.isSuccessful())
                {
                    ...
                    Intent intent=new Intent(Main3Activitynull.this,Main3Activitynull_retrieve.class);
                ...
                else
                {
                    ...
                    Toast.makeText(Main3Activitynull.this,"Error Occured :"+msg,Toast.LENGTH_LONG).show();
                }
