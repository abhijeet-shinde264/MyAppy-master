...
public class Main3Activitynull_retrieve extends AppCompatActivity {
    RecyclerView eventslist;
    DatabaseReference reference;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_main3_activitynull_retrieve);
        eventslist = (RecyclerView) findViewById(R.id.recyclerviewnull);
    ...
    private void validateeventslist() {
        ...
        reference= FirebaseDatabase.getInstance().getReference().child("Clubs").child("NULL");

        FirebaseRecyclerAdapter<Events, Main3Activitynull_retrieve.eventslistviewholder> firebaseRecyclerAdapter=new FirebaseRecyclerAdapter<Events, Main3Activitynull_retrieve.eventslistviewholder>
                (
                        Events.class,R.layout.events_info, Main3Activitynull_retrieve.eventslistviewholder.class,reference
                ) {
            @Override
            protected void populateViewHolder(Main3Activitynull_retrieve.eventslistviewholder viewHolder, Events model, int position) {
                ...
                viewHolder.itemView.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        Intent intent=new Intent(Main3Activitynull_retrieve.this,Android_details_student.class);
