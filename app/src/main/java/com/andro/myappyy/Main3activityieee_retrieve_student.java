...
public class Main3activityieee_retrieve_student extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_main3activityieee_retrieve_student);


        eventslist = (RecyclerView) findViewById(R.id.recyclerviewieee_student);
    ...
    private void validateeventslist() {
        ...
        reference= FirebaseDatabase.getInstance().getReference().child("Chapters").child("IEEE");

        FirebaseRecyclerAdapter<Events,Main3activityieee_retrieve_student.eventslistviewholder> firebaseRecyclerAdapter=new FirebaseRecyclerAdapter<Events,Main3activityieee_retrieve_student.eventslistviewholder>
                (
                        Events.class,R.layout.events_info, Main3activityieee_retrieve_student.eventslistviewholder.class,reference
                ) {
            @Override
            protected void populateViewHolder(Main3activityieee_retrieve_student.eventslistviewholder viewHolder, Events model, int position) {
               ...
               final String s6=model.getLink();
                ...
                viewHolder.itemView.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        Intent intent=new Intent(Main3activityieee_retrieve_student.this,Android_details_student.class);
