...
public class MainActivity extends AppCompatActivity {
    ...
    Integer[] imageId = {R.drawable.and_2, R.drawable.and_2, R.drawable.ml, R.drawable.iot,R.drawable.dsc,R.drawable.daa,
            R.drawable.nullclubb,R.drawable.animate,R.drawable.cloudclub};
    Integer[] imageId1= {R.drawable.ieee,R.drawable.and_2,R.drawable.csi,R.drawable.iste};
    String[] imagesName = {"image1", "image2", "image3", "image4","image5","image6","image7","image8","image10","image11"};
...
//no=getIntent().getStringExtra("number");
        ...
        public void run() {
            MainActivity.this.runOnUiThread(new Runnable() {
                ...
                public void run() {
                    ...
                    } else if (viewPager1.getCurrentItem() == 4) {
                        viewPager1.setCurrentItem(5);
                    } else if (viewPager1.getCurrentItem() == 5) {
                        viewPager1.setCurrentItem(6);
                    }else if (viewPager1.getCurrentItem() == 6) {
                        viewPager1.setCurrentItem(7);
                    }else if (viewPager1.getCurrentItem() == 7){
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (s){
            ...
            case R.id.dev:
                Intent intent1=new Intent(MainActivity.this,Developer_team.class);
